...
export default function AboutParalaxeLP() {
  return (
    <div
      ...
      style={{
        backgroundImage: `url(${LpPrevContent.about.bgImg})`,
          ...
          <SectionArea>
            <SectionWrapper>
              <div className="gap-y-[40px] flex flex-col items-center desktop1:flex-row desktop1:w-[100%] desktop1:justify-between desktop1:gap-[120px]">
                <img
                  src={LpPrevContent.about.logo.logoImg}
                  alt={LpPrevContent.about.logo.alt}
                  className="w-[100%] tablet2:w-[60%] desktop1:w-[40%] rounded-lg"
                />
                <div className="desktop1:w-[60%]">
                  <SectionHeader
                    className="text-center"
                    miniTitle={LpPrevContent.about.sectionHeader.miniTag}
                    sectionHeaderTitle={LpPrevContent.about.sectionHeader.title}
                    color=""
                    type="article"
                  />
                  <p className="font-mainFont mb-[36px]">
                    {LpPrevContent.about.paragraph}
                  </p>
                  <div className="w-full">
                    <Button
                      aria-label={
                        LpPrevContent.hero.textArea.ctaButtonAriaLabel
                      }
                      label={LpPrevContent.about.buttonLabel}
                      buttonLink={LpPrevContent.links.ctaWhatsapp}
                      animation
                      className=""
                      icon={
                        <svg
